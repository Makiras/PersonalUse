...
def get_video_links():
    try:
        video_json = requestsR().get(
            "https://www.xuexi.cn/lgdata/4426aa87b0b64ac671c96379a3a8bd26/db086044562a57b441c24f2af1c8e101.json").content.decode("utf8")
        ...
        while len(link) < 20:
            ...
            choose_json_str = requestsR().get(
                choose_json_url).content.decode("utf8")
